...
const Product = () => {
  ...
  return <div className="container section-space">
    ...
    <div className="grid gap-8 lg:grid-cols-2 lg:gap-14">
      ...
      <div className="my-6 rounded-md bg-secondary p-4 text-sm leading-relaxed">{product.demo ? "Sample device only. This listing does not confirm iWherehouse stock, specifications or a sales offer." : variant?.availableForSale ? "Ask your preferred branch about stock before visiting." : "This option is currently unavailable. Ask a branch about alternatives."}</div>
