...
### Setup
- Create a **new Shopify development store** so you can build, add products, and test checkout without payments. You can claim it later (30-day Shopify trial starts on claim) when ready to sell live.
...
- Gallery, variants (color/storage/size), stock, description, specs, related products, Add to Cart / Buy Now

**4. CPO (Certified Pre-Owned) landing page**
- What CPO means, quality assurance checklist, warranty info
- "Pioneer of CPO in Bacolod" story
- Curated CPO product grid

**5. Cart & Checkout**
- Slide-out cart drawer + full cart page
- Checkout handled by Shopify (supports GCash, Maya, COD, bank transfer once configured in Shopify Payments PH)
...
**7. Search**
- Global search with autocomplete (product name, category)

### Out of scope for v1 (can add later)
- About Us page, Repairs services page + repair request form, order tracking dashboard, Google Analytics, customer accounts. Easy to add in follow-up iterations.

### Tech
- React + Vite + Tailwind (existing stack)
- Shopify development store for catalog, cart, checkout, payments
- Mobile-first responsive across all pages

After approval I'll: enable Shopify (new store), offer the claim flow, then scaffold the storefront UI and wire it to your Shopify catalog. You'll add products through the Shopify admin (or I can help batch-create them).